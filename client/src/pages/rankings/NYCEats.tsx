...
import { MapPin, Navigation, Sparkles, ChevronLeft, ChevronRight, Star, Loader2 } from "lucide-react";
...
export default function NYCEats() {
  ...
  const isLoading = categoriesLoading || reviewsLoading;
                ...
                {categories.length > 0 && (
                  <div className="flex flex-wrap gap-2 mb-8">
                    {categories.map((category, index) => (
                      <Link key={category.id} href={`/nyc-eats/${category.slug}`}>
                        <Badge
                          variant="outline"
        ...
        {isLoading ? (
          ...
          <>
                          ...
                          >
                            <Card className="overflow-hidden border-0 shadow-md group">
                              <div className="relative aspect-[16/10]">
                                <img
                                  src={review.image || nycFoodBgImage}
                                  alt={review.name}
            ...
            <AnimatedSection animation="fade-in-up" delay={200} className="mb-12">
              ...
              <p className="font-sans text-muted-foreground">Explore NYC restaurants by category</p>
            </AnimatedSection>

            {categories.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-muted-foreground mb-4">No NYC categories have been created yet.</p>
                <p className="text-sm text-muted-foreground">Check back soon for category listings!</p>
              </div>
            ) : (
              <div
              ...
              >
                {categories.map((category, index) => (
                  <AnimatedSection 
                    ...
                    delay={300 + index * 75}
                  >
                    <Link href={`/nyc-eats/${category.slug}`}>
                      <Card 
            ...
            {reviews.length > 0 && (
              <>
                <AnimatedSection animation="fade-in-up" delay={200} className="mb-12 mt-16">
                  <h2 className="font-serif text-2xl md:text-3xl font-semibold text-foreground mb-2">
                    All NYC Reviews
                  </h2>
